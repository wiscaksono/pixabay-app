...
export default function Footer() {
  const navigation = [
    ...
    {
      name: "Instagram",
      href: "https://instagram.com/amachoker",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
      ...
      <div className="mx-auto max-w-7xl py-5 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <p className="text-center text-sm text-slate-400">
            &copy; 2022{"  "}
            <strong className="text-indigo-500">Wisnu Wicaksono</strong> ,
            Technical Test for Le Stud. All rights
          </p>
        </div>
      </div>
    </footer>
